...
// 'invoke')" errors across login, forgot-password, and registration:
// cloudSync.js and AuthContext.jsx call db.functions.invoke(...) / db.auth...
// directly, and this stub never had a `functions` key to invoke anything on,
// nor did those files even import `db` in the first place.
//
...
// environment, so this only needs a real client construction, not a new
