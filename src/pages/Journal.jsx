      ...
      <div className="flex items-center justify-between mb-4 gap-1.5">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="touch-44 w-9 h-9 rounded-full bg-muted flex items-center justify-center"
          >
            <ChevronLeft className="w-4 h-4" />
          </button>
          <button
            onClick={() => setMonth(new Date())}
            className="touch-44 px-2.5 h-9 rounded-full bg-muted flex items-center justify-center text-xs font-medium lowercase"
          >
            today
          </button>
          <button
